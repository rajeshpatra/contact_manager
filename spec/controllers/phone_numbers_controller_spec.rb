...
RSpec.describe PhoneNumbersController, type: :controller do
  ...
  describe "DELETE #destroy" do
    ...
    let(:joey) { Person.create(first_name: 'Joey', last_name: 'Tribiani') }
    let(:valid_attributes) { {number: '555-5678', person_id: joey.id} }
    let(:new_attributes) { {number: 'MyNewString', person_id: joey.id} }
